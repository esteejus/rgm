...
OUTPUT=/lustre19/expphy/volatile/clas12/users/erins/neutron-efficiency/out_d_pcdn
...
${BUILD_DIR}/neff_d_pcdn 0 2.07052 ${OUTPUT}/dCD_2gev_01${SLURM_ARRAY_TASK_ID}.root ${OUTPUT}/dCD_2gev_01${SLURM_ARRAY_TASK_ID}.pdf /w/hallb-scshelf2102/clas/clase2/erins/repos/rgm/NeutronEfficiency/cutfile_d_neff_pcd.txt ${INPUT}/01${SLURM_ARRAY_TASK_ID}/rec_clas_01${SLURM_ARRAY_TASK_ID}.evio.*.hipo
