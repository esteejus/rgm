 ...
 class clas12debug
 {
   ...
   */
   ...
   std::unique_ptr<TH2D> pid_proton_fd_debug = std::make_unique<TH2D>("pid_proton_fd_debug","PID Cut Proton FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_proton_cd_debug = std::make_unique<TH2D>("pid_proton_cd_debug","PID Cut Proton CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_piplus_fd_debug = std::make_unique<TH2D>("pid_piplus_fd_debug","PID Cut #pi + FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_piplus_cd_debug = std::make_unique<TH2D>("pid_piplus_cd_debug","PID Cut #pi + CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_kplus_fd_debug  = std::make_unique<TH2D>("pid_kplus_fd_debug","PID Cut K+ FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_kplus_cd_debug  = std::make_unique<TH2D>("pid_kplus_cd_debug","PID Cut K+ CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);

   std::unique_ptr<TH2D> pid_piminus_fd_debug  = std::make_unique<TH2D>("pid_piminus_fd_debug","PID Cut #pi + FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_piminus_cd_debug  = std::make_unique<TH2D>("pid_piminus_cd_debug","PID Cut #pi + CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_kminus_fd_debug   = std::make_unique<TH2D>("pid_kminus_fd_debug","PID Cut K+ FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_kminus_cd_debug   = std::make_unique<TH2D>("pid_kminus_cd_debug","PID Cut K+ CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_neutrals_fd_debug = std::make_unique<TH2D>("pid_neutrals_fd_debug","PID Cut neutrals FD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
   std::unique_ptr<TH2D> pid_neutrals_cd_debug = std::make_unique<TH2D>("pid_neutrals_cd_debug","PID Cut neutrals CD;Momentum (GeV/c);#Beta (v/c)",100,0,5,100,0,1.2);
