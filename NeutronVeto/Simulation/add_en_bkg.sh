...
j=$(printf "%05d" $index)
bg-merger -d "BMT,BST,FMT,HTCC,DC,CND,CTOF,ECAL,FTOF" -n $nevents -b ${BKGD_DIR}/c_$j.hipo -i ${INPUT_DIR}/isotropic_neutrons_mc_$index.hipo -o ${OUTPUT_DIR}/mc_neutrons_bkg_$index.hipo
