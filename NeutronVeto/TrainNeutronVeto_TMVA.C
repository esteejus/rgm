...
/*   TFile *input(0);
   ...
   std::cout << "--- TrainNeutronVeto_TMVA       : Using input file: " << input->GetName() << std::endl;*/

   // Register the training and test trees
   //TFile *inputS = TFile::Open("/w/hallb-scshelf2102/clas/clase2/erins/repos/neutron-veto/Simulation_eN/eN_bknd/bknd_root/good_neutrons_1.root","READ");
   //TFile *inputB = TFile::Open("/w/hallb-scshelf2102/clas/clase2/erins/repos/neutron-veto/Simulation_eN/eN_bknd/bknd_root/fake_neutrons_1.root","READ");
   ...
   for (int i=1; i<100; i++)
   {
     TString filenameS = inputDirectory + "good_neutrons_" + i + ".root";
...
*/
   ...
   // For an example of the category classifier usage, see: TrainNeutronVeto_TMVACategory
   //
   // --------------------------------------------------------------------------------------------------
